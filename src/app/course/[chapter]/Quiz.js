...
export default function Quiz({ questions, chapterId, chapterTitle }) {
  ...
  return (
    <div className="bg-white border-2 border-blue-200 rounded-2xl p-6 md:p-8 mb-10">
        ...
        >
          ...
          <p className="text-sm text-slate-600">
            {score === questions.length
              ...
              : score >= Math.ceil(questions.length / 2)
              ? "👍 Good effort! Review the incorrect answers below."
              ...
              <div className="space-y-2">
                {q.options.map((opt, optIdx) => {
                  ...
                  if (!submitted) {
                    ...
                    if (isAnswer) {
                      optClass += "border-green-500 bg-green-100 text-green-800";
                    } else if (isSelected && !isAnswer) {
                      optClass += "border-red-400 bg-red-100 text-red-700";
                    } else {
                      optClass += "border-slate-200 text-slate-400";
                    }
                  }
